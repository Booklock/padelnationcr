  ...
  return (
    <main className="section ranking-page">
      <div className="container">
        <section className="ranking-hero card">
          <div>
            ...
            <p className="section-description">
              Consultá el rendimiento de los jugadores por categoría, nivel y
              puntos acumulados durante la temporada.
            </p>
          </div>
        ...
        {loading && (
          <div className="empty-state card"><p>Cargando ranking…</p></div>
        )}
